...
CREATE OR REPLACE PUMP "PUMP1" AS
    INSERT INTO "STREAM1"
        SELECT STREAM
			DC_NOME,
			TEM_INS,
...
CREATE OR REPLACE STREAM "STREAM2" (
    ...
    TEMP_AR_F FLOAT,
    UMD_AR INTEGER,
    INDICE_CALOR_F NUMERIC(10,1)
);

CREATE OR REPLACE PUMP "PUMP2" AS
    INSERT INTO "STREAM2"
        SELECT STREAM
            CIDADE,
            TEMP_AR_C,
...
CREATE OR REPLACE STREAM "DESTINATION_SQL_STREAM" (
    ...
    TEMP_AR FLOAT,
    UMD_AR INTEGER,
    INDICE_CALOR NUMERIC(10,1),
    NIVEL_ALERTA VARCHAR(30)
);

CREATE OR REPLACE PUMP "FINAL_PUMP" AS
